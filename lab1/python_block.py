...
import python_block_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
...
class python_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0_0 = epy_block_0_0.blk(additionFlag=False)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.epy_block_0_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.epy_block_0_0, 1))
