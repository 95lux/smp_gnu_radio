...
# Author: Leon Braungardt, Jonas Lux
# Copyright: MIT
...
class sineWaveFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._sig_freq_range = qtgui.Range(-samp_rate/2, samp_rate/2, 100, 0, 200)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(0.01)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.audio_sink_0 = audio.sink(samp_rate, 'Analog (9+10)', True)
